...
let str = `
*ミ🖤 𝙷𝙾𝙻𝙰 ✨@${m.sender.split("@")[0]}✨, 𝙰𝚀𝚄𝙸 𝙴𝚂𝚃𝙰 𝙴𝙻 𝙼𝙴𝙽𝚄 𝙲𝙾𝙼𝙿𝙻𝙴𝚃𝙾 𝙳𝙴 🅚🅤🅡🅤🅜🅘_🅑🅞🅣 🖤彡*
...
['📮 𝙳𝙾𝙽𝙰𝚁 📮', '/donasi'],
['🐾 𝙸𝙽𝙵𝙾𝙱𝙾𝚃 🐾', '/infobot']
], m, { mentions: [m.sender], mentionedJid: [m.sender] })

/*conn.sendHydrated2(m.chat, str, wm, pp, 'https://www.paypal.me/siestaymarin', '𝙿𝙰𝚈𝙿𝙰𝙻', 'https://github.com/BrunoSobrino/TheMystic-Bot-MD', '🅚🅤🅡🅤🅜🅘_🅑🅞🅣', [
['📮 𝙳𝙾𝙽𝙰𝚁 📮', '/donasi'],
['🌹 𝙾𝚆𝙽𝙴𝚁 🌹', '/owner'],
['🐾 𝙸𝙽𝙵𝙾𝙱𝙾𝚃 🐾', '/infobot']
], m,)*/
...
handler.command = /^(menu|menú|memu|menucompleto|help|menu3|comandos|allmenu|2help|menu1.2|ayuda|commands|commandos)$/i
handler.exp = 50
handler.fail = null
